...
print("Please use the folowing guidelines to answer the survey.")
print("**This survey only accepts whole, positive numbers from 1-5.**")
print ("5 - Very Satisfied, 4 - Satisfied, 3 - Neutral, 2 - Unsatisfied, 1 - Very Unsatisfied")
print()
...
if product == "A" or product == "a":
	...
	manual = int(input("How satisfied are you with how self explanatory the manual/setting up instructions were?: "))
	privacy = int(input("How satisfied are you with our privacy policies?: "))
...
#creates report
suggestions = str(input("Please feel free to add any suggestions to improve this product: "))
print ()
